...
class BAPI_COMPANYCODE_GETLIST {
    ...
    void callFunction() throws Exception {
        ...
        SAPUtil.addOutputRow(outputParameters, SAPCallFunction.TABLE_OUTPUT, "COMPANYCODE_LIST", "COMP_CODE");
        SAPUtil.addOutputRow(outputParameters, SAPCallFunction.TABLE_OUTPUT, "COMPANYCODE_LIST", "COMP_NAME");
        ...
        SAPUtil.callFunction("destination", "BAPI_COMPANYCODE_GETLIST", inputParameters, outputParameters);
    }
